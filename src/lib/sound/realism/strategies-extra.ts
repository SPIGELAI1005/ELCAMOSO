...
export const EXPANSION_STRATEGIES: ProfileStrategy[] = [
  ...
  },
  {
    ...
    build(ctx, buses) {
      return [
        createNeonPulseLayer(ctx, { id: "neon", destination: buses.body, level: 0.85 }),
        createFilteredNoiseLayer(ctx, {
          id: "city-haze",
          destination: buses.beds,
          color: "pink",
  ...
  },
  {
    ...
    build(ctx, buses) {
      return [
        ...
        createHydraulicLayer(ctx, { id: "hydraulics", destination: buses.accents, level: 0.52 }),
        createOneShotEventLayer(ctx, {
          id: "metal-clunk",
          destination: buses.accents,
          level: 1,
