...
const BUILT_IN_SOUND_PROFILES: SoundProfile[] = [
  ...
  },
  {
    ...
    name: "UFO",
    category: "Future",
    traits: ["Theremin", "Gliding", "Otherworldly"],
    description:
      "A classic saucer theremin: high wavering tone, continuous glides, and that eerie sci-fi moan as you move.",
    drivetrainMode: "continuous",
    voice: {
      baseFrequency: 740,
      harmonics: [1],
  ...
  },
  {
    ...
    voice: {
      ...
      wave: "triangle",
      coreLevel: 0.18,
      rhythm: { kind: "laugh", baseRate: 0.8, rateScale: 3.6, level: 0.55, tone: 210 },
      textures: [{ kind: "crowd", level: 0.1, tone: 900, speedScale: 0.85, surge: 0.55 }],
      signals: [{ kind: "laugh", everySeconds: 4, jitter: 2, level: 0.42, tone: 160 }],
    },
  },
  {
    id: "farting-car",
    ...
    voice: {
      ...
      lfoDepth: 140,
      lfoTarget: "pitch",
      rhythm: { kind: "blat", baseRate: 1.1, rateScale: 6.5, level: 0.42, tone: 90 },
      coreLevel: 0.22,
    },
